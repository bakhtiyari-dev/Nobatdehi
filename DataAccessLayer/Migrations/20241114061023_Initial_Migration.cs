        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SaterdayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    SaterdayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    SundayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    SundayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    MondayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    MondayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    tuesdayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    tuesdayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    wednesdayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    wednesdayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    thursdayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    thursdayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    fridayFirstHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    fridayLasttHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    OfficePlanOptionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
